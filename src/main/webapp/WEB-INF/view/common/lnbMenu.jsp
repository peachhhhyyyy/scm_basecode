...
<div id="lnb_area">
	...
	<div class="login">
		<img src="/images/admin/comm/left_myImg.jpg" class="LoginImg" alt="사진" /> <span class="LoginName">${sessionScope.userNm}</span>
			...
			<li>
				<dl>
					<dt>
						...
						<a class="lnbBtn ${list.mnu_ico_cod}" href="#">${list.mnu_nm}</a>
					</dt>
					<dd>
