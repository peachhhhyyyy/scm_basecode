...
public class UserInfo {
	...
	/*
	 * loginID , user_type , name , password , email_cop , birthday , gender_cd
	 * , user_tel1 , user_tel2 , user_tel3 , user_zipcode , user_address ,
	 * user_dt_address , consult_yn , del_cd , div_cd , user_email ,
	 * user_company , approval_cd
	 */
